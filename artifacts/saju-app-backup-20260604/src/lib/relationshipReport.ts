...
const SPOUSE_PALACE: Record<string, SpousePalaceInfo> = {
  자: {
    ...
    summary: "배우자궁에 수 기운이 흘러 감수성이 풍부하고 직관적인 관계를 형성합니다.",
  ...
  축: {
    ...
    summary: "배우자궁에 토 기운이 자리하여 안정감과 신뢰를 중심으로 한 관계를 추구합니다.",
  ...
  인: {
    ...
    summary: "배우자궁에 목 기운이 강하여 활동적이고 성장 지향적인 관계를 형성합니다.",
  ...
  묘: {
    ...
    summary: "배우자궁에 을목 기운이 있어 섬세하고 예술적 감수성이 풍부한 관계를 형성합니다.",
  ...
  진: {
    ...
    summary: "배우자궁에 수 기운을 머금은 토가 있어 실용적이면서도 깊이 있는 관계를 형성합니다.",
  ...
  사: {
    ...
    summary: "배우자궁에 화 기운이 있어 지성과 열정이 균형 잡힌 관계를 추구합니다.",
  ...
  오: {
    ...
    summary: "배우자궁에 정화 기운이 강하여 열정적이고 활발한 관계를 형성합니다.",
  ...
  미: {
    ...
    summary: "배우자궁에 목·화 기운이 담긴 미토가 있어 감수성이 풍부하고 온화한 관계를 추구합니다.",
  ...
  신: {
    ...
    summary: "배우자궁에 금 기운이 있어 현실적이고 능력 있는 파트너십을 추구합니다.",
  ...
  유: {
    ...
    summary: "배우자궁에 신금 기운이 있어 세련되고 품격 있는 관계를 추구합니다.",
  ...
  술: {
    ...
    summary: "배우자궁에 금·화 기운이 담긴 술토가 있어 충직하고 의리를 중시하는 관계를 형성합니다.",
  ...
  해: {
    ...
    summary: "배우자궁에 수 기운이 있어 자유롭고 독립적인 관계를 추구합니다.",
...
const COMPLEMENTARY: Record<string, { branches: string[]; elements: string[]; guidance: string }> = {
  ...
  인: { branches: ["해", "오", "묘"], elements: ["수", "화"], guidance: "해수 기운이 목 기운을 돕는 구조로 궁합이 좋습니다. 인오술 화국 인연으로 활동적인 관계가 됩니다." },
  묘: { branches: ["인", "해", "미"], elements: ["수", "토"], guidance: "해수·인목과 조화롭습니다. 해묘미 목국이 형성되면 성장 지향적인 깊은 인연입니다." },
  진: { branches: ["자", "유", "신"], elements: ["수", "금"], guidance: "자수·유금이 좋은 보완 관계입니다. 신자진 수국이 되면 조화롭고 안정적인 관계가 됩니다." },
  사: { branches: ["인", "오", "술"], elements: ["목", "화"], guidance: "인목·오화와 잘 어울립니다. 인오술 화국이 되면 열정적인 강한 인연입니다." },
  오: { branches: ["인", "술", "미"], elements: ["목", "토"], guidance: "인목이 화 기운을 돕는 구조로 생기 있는 관계가 됩니다. 인오술 화국에서 특히 강한 인연입니다." },
  미: { branches: ["오", "인", "해"], elements: ["화", "목", "수"], guidance: "오화·인목과 조화롭습니다. 해묘미 목국이 형성되면 풍요롭고 감성적인 관계입니다." },
  신: { branches: ["자", "진", "사"], elements: ["수", "토", "화"], guidance: "사화·자수와 상호 보완적입니다. 신자진 수국이 되면 현실적이고 안정적인 관계입니다." },
  유: { branches: ["사", "축", "신"], elements: ["화", "토"], guidance: "사화·축토와 잘 맞습니다. 사유축 금국이 되면 격조 있고 안정적인 관계입니다." },
  술: { branches: ["인", "오", "해"], elements: ["목", "화", "수"], guidance: "인목·오화와 조화롭습니다. 인오술 화국으로 뜨겁고 충실한 인연을 형성합니다." },
...
export function getMarriageTimingHint(
  ...
  const general = isFemale
    ? "정관·편관 운이 들어오는 시기에 결혼운이 강화됩니다. 관성 흐름을 주목하세요."
    : "정재·편재 운이 들어오는 시기에 인연운이 활성화됩니다. 재성 흐름을 주목하세요.";
  ...
  const favorable = isFemale
    ? "관성이 풍부한 시기, 일지와 합을 이루는 연도에 인연이 맺어지기 쉽습니다."
    : "재성이 활발한 시기, 인연의 세운이 들어오는 해를 주목하세요.";
...
function getElementalRelationshipDesc(counts: FiveElementCount): string {
  ...
  if (dominant.includes("화")) return "화 기운이 강하여 관계에서 열정적이고 표현이 풍부합니다.";
  if (dominant.includes("수")) return "수 기운이 강하여 감성적이고 직관적인 관계를 형성합니다.";
  if (dominant.includes("목")) return "목 기운이 강하여 성장 지향적이고 진취적인 관계를 형성합니다.";
  if (dominant.includes("금")) return "금 기운이 강하여 원칙적이고 신뢰감 있는 관계를 선호합니다.";
  if (dominant.includes("토")) return "토 기운이 강하여 안정적이고 신뢰를 중시하는 관계를 형성합니다.";
