...
export function buildCompatibilityClipboardText(
  ...
  lines.push("[AI 해석 요청 프롬프트]");
  lines.push("당신은 20년 경력의 통찰력 있고 따뜻한 명리학 전문가입니다.");
  lines.push("위의 두 사람의 사주 구조 및 궁합 분석 데이터를 바탕으로, 내담자에게 직접 말하듯 다정하고 이해하기 쉬운 현대적인 언어로 다음 목차에 따라 궁합을 해석해 주세요.");
  lines.push("");
  lines.push("1. 💞 두 사람의 궁합 요약 및 가장 큰 장점");
  lines.push("2. ⚠️ 관계에서 발생할 수 있는 주의점 및 갈등 요소");
  lines.push("3. 💡 더 건강한 관계를 유지하기 위한 3가지 현실적인 조언");
  lines.push("");
  lines.push("어려운 명리 용어는 알기 쉽게 풀어서 설명하고, 긍정적인 관계 발전 방향을 제시해 주세요.");
