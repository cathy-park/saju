...
export const PERSONAL_AREAS: IntegratedArea[] = [
  ...
  { key: "romance", title: "연애", hint: "호감, 애정 표현과 친밀감", themes: ["relationshipNeeds", "intimacyConflict"] },
  { key: "marriagePartner", title: "결혼·배우자", hint: "장기 관계에서 원하는 구조와 조율", themes: ["longTermRelationship"] },
