...
function SectionCard({ section, polishedText }: { section: CareerReportSection; polishedText?: string }) {
  return (
...
export default function ZiweiCareerReport() {
  ...
  return (
    <div className="ds-app-shell ds-page-pad py-8 ds-section-gap">
      ...
      <h1 className="ds-title-lg">{person.birthInput.name}님의 커리어 리포트</h1>
