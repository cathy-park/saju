...
export default async function handler(req: VercelLikeRequest, res: VercelLikeResponse) {
  ...
  const prompt = [
    ...
    "3. 기술 용어·점수·원자료를 그대로 나열하지 말고, 이 사람이 실제로 어떻게 생각하고 행동하고 관계를 맺는지로 표현하세요.",
    "4. 분량은 보통 2~4문장이면 충분합니다. \"~기질\", \"~흐름이 있습니다\" 같은 표현의 반복은 최소화하세요.",
    "5. 결과는 다듬어진 문장만 출력하세요(설명, 따옴표, 목록 형식, 접두사 금지).",
    "",
    "[사실 목록]",
    factLines,
    "",
